...
<body>
<div class="jumbotron">
  <h1 class="display-4">لائحة الزبناء</h1>
  <p class="lead">هنا يمكنك زيارة زبون ما  </p>
  <hr class="my-4">
...
<input type="text" id="myInput" onkeyup="myFunction()" placeholder="البحث عن اسماء الزبناء ...">
